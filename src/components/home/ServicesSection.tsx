...
export default function ServicesSection() {
  return (
    ...
    >
      <div className="absolute inset-x-0 top-16 h-64 bg-[radial-gradient(circle_at_center,rgba(56,189,248,0.08),transparent_45%)] blur-3xl" />
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {services.map((service) => {
            ...
            return (
              <div
                key={service.title}
                className="group rounded-[30px] border border-white/10 bg-[#10161f]/90 p-6 shadow-[0_18px_50px_rgba(0,0,0,0.20)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:border-sky-400/30 hover:bg-[#131b26]"
              >
